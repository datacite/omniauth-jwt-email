require "date"
require File.expand_path("../lib/omniauth/jwt_email/version", __FILE__)

Gem::Specification.new do |s|
  s.authors       = "Martin Fenner"
  s.email         = "mfenner@datacite.org"
  s.name          = "omniauth-jwt-email"
  s.homepage      = "https://github.com/datacite/omniauth-jwt-email"
  s.summary       = "JWT email strategy for OmniAuth"
  s.date          = Date.today
  s.description   = "Use short-lived JWT for one-time authentication, e.g. for passwordless authentication via email"
  s.require_paths = ["lib"]
  s.version       = OmniAuth::JwtEmail::VERSION
